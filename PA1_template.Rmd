...
From this we discover that the `r stepsbyinterval[which.max(stepsbyinterval[,"avgsteps"]),"interval"]` interval in the morning is the highest average peak of activity level throughout any given day.
...
Looking at a summary of the full data set, we see there are `r sum(is.na(activity$steps))` missing *steps* data points.
